...
def _credential_document(password: str, token: str) -> str:
    ...
    sections = [
        ...
        },
        {
            ...
            "Website": "https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/do-more-with-tunnels/trycloudflare/",
            "Account email": "Not required",
            "Username": "Not required",
            "Password": "Not required",
            "API key": "Not required",
            "API secret/token": "Not required",
            "Account/project ID": "Ephemeral quick tunnel",
            "Free plan/tier": "Free TryCloudflare quick tunnel",
            ...
            "Notes": "The hostname changes when restarted; start-ai-trader.ps1 updates GitHub Pages automatically.",
        },
        {
