...
def _credential_document(password: str, token: str) -> str:
    ...
    sections = [
        ...
        },
        {
            ...
            "Website": "https://developers.cloudflare.com/cloudflare-one/networks/connectors/cloudflare-tunnel/trycloudflare/",
            "Account email": "Not required",
            "Username": "Not required",
            "Password": "Not required",
            "API key": "Not required",
            "API secret/token": "Not required",
            "Account/project ID": "Ephemeral account-less Quick Tunnel",
            "Free plan/tier": "Free Quick Tunnel",
