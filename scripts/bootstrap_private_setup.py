...
def _credential_document(password: str, token: str) -> str:
    ...
    sections = [
        ...
        {
            "Service": "localhost.run HTTPS tunnel",
            ...
            "Notes": "Selected because this machine's configured DNS blocks trycloudflare.com. The hostname changes when restarted; start-ai-trader.ps1 updates GitHub Pages automatically.",
        },
        {
